...
$row_produto = $lista->fetch_assoc();//primeiro registro que ele encontrou na matriz associativa
$num_linhas = $lista->num_rows;//quantas linhas retornou essa consulta NUM_ROWS;
?>
...
<?php  if($num_linhas > 0){?>
    ...
    <div class="row"> <!-- linha -->
     ...
     <?php }while($row_produto = $lista->fetch_assoc());//retorna a proxima linha ?> 
    </div>
    <?php }?>