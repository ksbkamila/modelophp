...
if($_POST){
  ...
  //die();
    ...
    if(!isset($_SESSION)){ // se não tiver atribuição para variavel sessão //exemplo: se um usuario recebeu um link que vai direto pra página de login, isso aqui roda.
...
if($numRow > 0){
    ...
    {
        echo "<script>window.open('index.php', '_self')</script>"; //pagina do administrador vai abrir no mesmo lugar e não p outra aba
    }else{
