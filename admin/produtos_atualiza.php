...
if($_POST){ //se o usuario clicou no botão atualizar 
  ...
  if($result){
   header('lacation: produtos_lista.php');
  }
}
                            ...
                            <select name="id_tipo" id="id_tipo" class="form-control" required>
                               <?php do{?>
                                    <option value="<?php echo $rowTipo['id']?>" 
                                     <?php 
                                      if(!(strcmp($rowTipo['id'], $row['tipo_id']))){ //se o id do tipo que esta no tipo for igual que esta no produto ai vai trazer esse cara como selected 
