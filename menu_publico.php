<?php 
include "conn/connect.php"; //inclui a pasta conn aqui
$lista_tipos = $conn->query("select * from tipos order by rotulo");
$rows_tipos = $lista_tipos->fetch_all(); //pega todos os resultados de arrays associativas 
 //var_dump serve para descarragar uma variavel matiz
